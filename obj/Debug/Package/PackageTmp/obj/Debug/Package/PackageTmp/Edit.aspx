<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageBeta.master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="TraCuuVB.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <span class="form-title">Sửa thông tin văn bản văn bản</span> 
<div class='dieukien'>
    
      <div class="row">
                <span class="col-1">ID văn bản (UD tự sinh) </span>
                <span class="col-2">  <asp:TextBox ID="txtIdVanBan" runat="server"  Width="40%"  Font-Bold="true" Enabled="false"></asp:TextBox>  </span>                
     </div> <%--end row 1--%>
     <div class="row">
                <span class="col-1">Số hiệu văn bản* </span>
                <span class="col-2">  <asp:TextBox ID="txtSoHieuVB" runat="server"  Width="90%"></asp:TextBox>    
                         </span>
       ...
       <div class="row">
                ...
                <span class="col-2">  <asp:TextBox ID="txtNoiDung" runat="server" Width="230%" 
     ...
     <div class="row">
                ...
                <span class="col-2"><asp:TextBox ID="txtNgayBanHanh" runat="server"  Width="40%" ></asp:TextBox>  </span>
     ...
     <div class="row">
                ...
                <span class="col-2"> <asp:TextBox ID="txtNgayHieuLuc" runat="server"  Width="90%"></asp:TextBox> </span> 
                <span class="col-3"> </span>
                <span class="col-4"> </span>               
    ...
    <div class="row">
      ...
      <div class="row">
                ...
                <span class="col-2"> <asp:HyperLink ID="lnkVanBan" runat="server" Text="Hari">Download</asp:HyperLink> <asp:FileUpload ID="fuUpload1" runat="server" />
                </span>                
                <span class="col-3"></span>
                <span class="col-4"> </span>
     </div> <%--end row 4--%>
     ...
     <%--<div class="row">
                <span class="col-1">File văn bản 2 </span>
                <span class="col-2"> <asp:FileUpload ID="fuUpload2" runat="server" /> </span>                
                <span class="col-3"></span>
                <span class="col-4"> </span>
     </div> <%--end row 4--%>

      <div class="row">
        <span class="col-1"><asp:Button ID="butThayDoi" runat="server" Text="Lưu thay đổi"    onclick="butLuuThayDoi_Click" /> </span>
